namespace finaltesting
{
    partial class enrollment
    {
        ...
        private void InitializeComponent()
        {
			...
			this.referencegrid = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.referencegrid)).BeginInit();
			this.SuspendLayout();
			// 
			// fingerprint
			// 
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.referencegrid);
			...
			// referencegrid
			// 
			this.referencegrid.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.referencegrid.Location = new System.Drawing.Point(6, 29);
			this.referencegrid.Name = "referencegrid";
			this.referencegrid.Size = new System.Drawing.Size(459, 165);
			this.referencegrid.TabIndex = 0;
			// 
			// label7
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.referencegrid)).EndInit();
		...
		private System.Windows.Forms.DataGridView referencegrid;
